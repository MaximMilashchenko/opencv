...
protected:
    ...
    bool selectMediaType(const cv::VideoCaptureParameters&);
...
bool CvCapture_MSMF::selectMediaType(const cv::VideoCaptureParameters& params)
{
    ...
    else if (isOpen)
    {
        ...
        for(;;)
        {
            ...
            if (!SUCCEEDED(hr = videoFileSource->ReadSample(
                ...
                enable_audio ? NULL : &sampleTime,   // Receives the time stamp.
